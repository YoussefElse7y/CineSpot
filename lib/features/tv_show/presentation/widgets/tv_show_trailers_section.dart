...
class TvShowTrailersSection extends StatelessWidget {
  const TvShowTrailersSection({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<TvShowBloc, TvShowState>(
      ...
      builder: (context, state) {
        if (state.videosStatus == TvShowVideosStatus.loading) {
        ...
        if (state.videosStatus == TvShowVideosStatus.error) {
          return Padding(
        ...
        if (state.videosStatus == TvShowVideosStatus.loaded &&
            state.tvShowVideos != null &&
            state.tvShowVideos!.isNotEmpty) {
          final trailers = state.tvShowVideos!;
