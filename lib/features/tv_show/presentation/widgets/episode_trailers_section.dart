...
class EpisodeTrailersSection extends StatelessWidget {
  const EpisodeTrailersSection({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<TvShowBloc, TvShowState>(
      buildWhen: (previous, current) =>
          previous.episodeVideosStatus != current.episodeVideosStatus,
      builder: (context, state) {
        if (state.episodeVideosStatus == EpisodeVideosStatus.loading) {
        ...
        if (state.episodeVideosStatus == EpisodeVideosStatus.error) {
          return Padding(
        ...
        if (state.episodeVideosStatus == EpisodeVideosStatus.loaded &&
            state.episodeVideos != null &&
            state.episodeVideos!.isNotEmpty) {
          final videos = state.episodeVideos!;
