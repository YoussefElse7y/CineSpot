  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<MovieBloc, MovieState>(
      ...
      builder: (context, state) {
        ...
        if (state.creditsStatus == MovieCreditsStatus.error) {
          return Padding(
        ...
        if (state.creditsStatus == MovieCreditsStatus.loaded &&
            state.credits != null &&
            state.credits!.cast.isNotEmpty) {
          return Column(
              ...
              SizedBox(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    final cast = state.credits!.cast[index];
                    return Padding(
