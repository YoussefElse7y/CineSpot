  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<MovieBloc, MovieState>(
      ...
      builder: (context, state) {
        if (state.recommendationsStatus == MovieRecommendationsStatus.loading) {
        ...
        if (state.recommendationsStatus == MovieRecommendationsStatus.error) {
          return Padding(
        ...
        if (state.recommendationsStatus == MovieRecommendationsStatus.loaded &&
            state.recommendations != null &&
            state.recommendations!.results.isNotEmpty) {
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ListView.builder(
                  ...
                  padding: const EdgeInsets.symmetric(horizontal: 16),
                  itemCount: state.recommendations!.results.length,
                  itemBuilder: (context, index) {
                    final movie = state.recommendations!.results[index];
                    return Padding(
