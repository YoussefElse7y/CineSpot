...
class WatchProvidersScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    context.read<MovieBloc>().add(MovieEvent.loadWatchProviders(movieId));
    ...
    return Scaffold(
      ...
      body: BlocBuilder<MovieBloc, MovieState>(
        ...
        builder: (context, state) {
          if (state.watchProvidersStatus == MovieWatchProvidersStatus.loading) {
          ...
          if (state.watchProvidersStatus == MovieWatchProvidersStatus.loaded &&
            ...
            return SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Rent Section
                  if (egyptData.rent != null && egyptData.rent!.isNotEmpty) ...[
                    _ProviderSection(
                      title: 'Rent',
